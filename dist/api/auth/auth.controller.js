...
const select_subscriber_dto_1 = require("./dto/select-subscriber.dto");
...
__decorate([
    ...
    (0, common_1.UseGuards)(auth_guard_1.AuthGuard),
    (0, authGuardPermisssion_1.AuthGuardPermissions)({
        allowedUsers: [auth_type_1.UserType.USER],
    }),
    (0, common_1.Post)('/select-subscriber'),
    (0, common_1.HttpCode)(200),
    __param(0, (0, authUser_1.AuthUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, select_subscriber_dto_1.SelectSubscriberDto]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "selectSubscriber", null);
